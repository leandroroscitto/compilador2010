	...
	public static void main(String[] args) throws ExcepALexico, ExcepASintatico {
		...
		if (args.length > 0) {
			...
			try {
				...
				// Si llega aqui sin producer una excepción, el codigo
				...
				System.out
						.println("IOException capturada, no se pudo leer del archivo.");
			}
		} else {
			// Faltó el parametro de entrada
			System.out
					.println("De como parametro al menos un nombre para el archivo de entrada.");
		}
	}
}
